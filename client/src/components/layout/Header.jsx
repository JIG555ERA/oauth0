...
const Header = ({active=''}) => {
  ...
  return (
    <div className='w-[96vw] h-[80px] absolute top-6 bg-gradient-to-br from-white/10 via-white/5 to-white/10 2xl:px-[120px] lg:px-[90px] md:px-[60px] px-[16px] rounded-3xl'>
